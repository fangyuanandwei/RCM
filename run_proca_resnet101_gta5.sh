...
--nproc_per_node=$NGPUS train_src.py
-cfg configs/gta5/deeplabv2_r101_src.yaml
SOLVER.LAMBDA_LOV 0.75 OUTPUT_DIR
results/gta5/r101_g2c_src SOLVER.BATCH_SIZE 8
...
-cfg configs/gta5/deeplabv2_r101_proca.yaml 
DATASETS.TEST cityscapes_train 
resume results/gta5/r101_g2c_ours_proca/model_best.pth 
OUTPUT_DIR results/gta5/r101_g2c_ours_proca 
SOLVER.BATCH_SIZE_VAL 1


# train with generated pseudo label
python train_ssl.py -cfg configs/gta5/deeplabv2_r101_ssl.yaml PREPARE_DIR results/gta5/r101_g2c_ours_proca/ OUTPUT_DIR results/gta5/r101_g2c_ours_proca_ssl SOLVER.BATCH_SIZE 8
