...
def train(cfg, local_rank, distributed, logger):
    ...
    src_train_data = build_dataset(cfg, mode='train', is_source=True,Version= 'v2')
    ...
    for i, (src_input, src_label, src_name) in enumerate(train_loader):
...
def main():
    ...
    logger = setup_logger("SelfSupervised", output_dir, args.l
    ocal_rank)
