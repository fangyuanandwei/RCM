...
class GTAVDataSet(data.Dataset):
    ...
    def __init__(self,
        ...
        label_stattics_root = './label_statics/gtav/'


        if max_iters is not None:
            self.label_to_file, self.file_to_label = pickle.load(
                open(osp.join(label_stattics_root , "gtav_label_info.p"),
                     "rb"))
            self.img_ids = []
            SUB_EPOCH_SIZE = 3000
            tmp_list = []
        ...
        for name in self.img_ids:
            self.data_root = '/media/lxj/d3c963a4-6608-4513-b391-9f9eb8c10a7a/DA/Data/GTA5/'
