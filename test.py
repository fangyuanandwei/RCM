...
def main():
    ...
    parser.add_argument("-cfg",
                        "--config-file",
                        default="configs/synthia/deeplabv2_r101_ssl.yaml",
                        metavar="FILE",
                        help="path to config file",
                        type=str,
                        )
    '-cfg configs/synthia/deeplabv2_r101_ssl_synthia.yaml resume results/model_proca_ssl.pth'
    parser.add_argument(
        "opts",
    ...
    cfg.resume = './results/synthia/r101_g2c_ours_proca_ssl//model_best_0.5265507698059082.pth'
